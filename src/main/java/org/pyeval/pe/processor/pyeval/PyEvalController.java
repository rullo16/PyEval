...
public class PyEvalController extends StandaloneEventProcessingDeclarer<PyEvalParameters> {
	...
	private final String PyObject = "def process(event):\n\n	return(event)";

	@Override
	public DataProcessorDescription declareModel() {
		return ProcessingElementBuilder.create("org.pyeval.pe.processor.pyeval")
				...
				.requiredStream(StreamRequirementsBuilder
						...
						.build())
					.requiredCodeblock(Labels.withId(PY_FUNCTION), CodeLanguage.Javascript, PyObject)
					.outputStrategy(OutputStrategies.userDefined())
					.build();
	}

	@Override
	public ConfiguredEventProcessor<PyEvalParameters> onInvocation
